# Skeleton Code for SegNet Implementation Assignment, Computer Vision
...
(Optional) If you installed TensorBoard and tensorboardX, then you should have TensorBoard logs saved to `out/logs`. You can monitor the logs (loss curves, validation visualization, etc.) on [http://localhost:6006](http://localhost:6006) via:
